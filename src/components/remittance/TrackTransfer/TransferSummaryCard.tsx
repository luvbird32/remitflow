  ...
  return (
    <div className="modern-card p-6 border-l-4 border-blue-500">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-xl font-bold text-slate-800">Money Transfer #{transferData.id}</h3>
      ...
      <div className="grid grid-cols-2 gap-6">
        <div>
          <span className="text-slate-500 text-sm font-medium">Amount Sent</span>
          <p className="text-2xl font-bold text-slate-800">
            {transferData.currency} {transferData.amount}
          </p>
        </div>
        <div>
          <span className="text-slate-500 text-sm font-medium">Date Sent</span>
